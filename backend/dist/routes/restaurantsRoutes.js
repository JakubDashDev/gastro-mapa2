...
router.route("/:query?").get((0, asyncHandler_js_1.default)(restaurantController_js_1.getAllRestaurants)).post(authMiddleware_js_1.protect, restaurantController_js_1.createRestaurant);
